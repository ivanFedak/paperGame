...
var game = function game() {
  ...
  contentBlock = document.querySelector('.content'),
      //Second screen
  items = document.querySelectorAll('.main__item'),
      //Every hand
  picked = document.querySelector('.content__column_you .content__item'),
      //User (Wrapper for img )
  pcRand = document.querySelector('.content__column_house .content__item'),
      //Pc 
  ...
  var pickComputerHand = function pickComputerHand(userHand) {
    var hands = _toConsumableArray(items); //all hands from main + create new obj


    var rand = hands[Math.floor(Math.random() * 3)]; //random hand 
  ...
  var result = function result(userHand, pcHand) {
    var userValue = userHand.dataset.name,
  ...
  var decision = function decision(result) {
    resText.textContent = result; //Color border
